...
class AUTOCRAFT_API server : public std::enable_shared_from_this<server>
{
private:
...
private:
    connections                              conns_;
    player_conns                             player_conns_;
    std::shared_ptr<master_conn>             master_conn_;
    entities                                 entities_;
